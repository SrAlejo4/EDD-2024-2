...
public class Yamahita {
    ...
    public Yamahita[][] llenarMatrizYamahitas(int dim){
        Yamahita[][] servidorCentral = new Yamahita[dim][dim];
    ...
    public void buscarProducto(Yamahita[][] matrizSearch ,String nombre){
    ...
    public void buscarPrecioMayor(Yamahita[][] matrizSearchPrecio){
        double precioMax = 0;
        String nombreMax = "";
        int cantidadMax = 0;
    ...
    public static void main(String[] args) {
        Scanner entrada = new Scanner(System.in);
        Yamahita servidor = new Yamahita();

        System.out.print("\n INGRESE LA DIMENSIÓN DE LA MATRIZ: ");
        int dim = entrada.nextInt();
        Yamahita[][] matrizServidor = new Yamahita[dim][dim];
        matrizServidor = servidor.llenarMatrizYamahitas(dim);
